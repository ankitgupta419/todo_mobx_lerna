...
storiesOf("Dropdowns", module)
  .add(
    ...
    withReadme(
      DropdownReadme,
      withDocs(DropdownSimpleDoc, () => <SimpleDropdown />)
    )
  )
  .add(
    ...
    withReadme(
      DropdownReadme,
      withDocs(DropdownContextualVariationsDoc, () => (
  ...
  .add(
    ...
    withReadme(
      DropdownReadme,
      withDocs(DropdownDividerDoc, () => <DropdownWithDivider />)
    )
  )
  .add(
    "Dropdown split",
    withReadme(
      DropdownReadme,
      withDocs(DropdownSplitDoc, () => <DropdownSplit />)
    )
  )
  .add(
    "Dropdown sizing",
    withReadme(
      DropdownReadme,
      withDocs(DropdownSizingDoc, () => <DropdownSizing />)
    )
  );
