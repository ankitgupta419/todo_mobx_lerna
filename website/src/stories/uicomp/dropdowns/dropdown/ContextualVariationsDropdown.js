      ...
      <Container style={{ textAlign: "left" }}>
        <Dropdown mb="0.5rem">
          <Button
            primary
            dropdownToggle
            onClick={() => this.handleOpenCloseDropdown("hiddenPrimary")}
          >
            Primary
          </Button>
        ...
        <Dropdown mb="0.5rem">
          <Button
            secondary
            dropdownToggle
            onClick={() => this.handleOpenCloseDropdown("hiddenSecondary")}
          >
            Secondary
          </Button>
        ...
        <Dropdown mb="0.5rem">
          <Button
            success
            dropdownToggle
            onClick={() => this.handleOpenCloseDropdown("hiddenSuccess")}
          >
            Success
          </Button>
        ...
        <Dropdown mb="0.5rem">
          <Button
            info
            dropdownToggle
            onClick={() => this.handleOpenCloseDropdown("hiddenInfo")}
          >
            Info
          </Button>
        ...
        <Dropdown mb="0.5rem">
          <Button
            warning
            dropdownToggle
            onClick={() => this.handleOpenCloseDropdown("hiddenWarning")}
          >
            Warning
          </Button>
        ...
        <Dropdown mb="0.5rem">
          <Button
            danger
            dropdownToggle
            onClick={() => this.handleOpenCloseDropdown("hiddenDanger")}
          >
            Danger
          </Button>
        ...
        <Dropdown mb="0.5rem">
          <Button
            light
            dropdownToggle
            onClick={() => this.handleOpenCloseDropdown("hiddenLight")}
          >
            Light
          </Button>
        ...
        <Dropdown mb="0.5rem">
          <Button
            dark
            dropdownToggle
            onClick={() => this.handleOpenCloseDropdown("hiddenDark")}
          >
            Dark
          </Button>
