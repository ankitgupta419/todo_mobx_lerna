...
storiesOf("Forms", module)
  ...
  .add(
    ...
    withReadme(
      FormReadme,
      withDocs(FormReadonlyPlainTextDocs, () => (
        <Container fluid style={{ textAlign: "left" }}>
          <form>
            <FormGroup row>
              <Column sm={3}>
  ...
  .add(
    ...
    withReadme(
      FormReadme,
      withDocs(FormCheckboxRadioDefaultDocs, () => (
        <Container fluid style={{ textAlign: "left" }}>
          <form>
            <FormCheck>
              <FormCheckInput type="checkbox" />
  ...
  .add(
    ...
    withReadme(
      FormReadme,
      withDocs(FormCheckboxRadioInlineDocs, () => (
        <Container fluid style={{ textAlign: "left" }}>
          <form>
            <FormCheck inline>
              <FormCheckInput type="checkbox" />
  ...
  .add(
    "Checkboxes and radios without label",
    withReadme(
      FormReadme,
      withDocs(FormCheckboxRadioWOLabelDocs, () => (
        <Container fluid style={{ textAlign: "left" }}>
          <form>
            <FormCheck>
              <FormCheckInput type="checkbox" />
