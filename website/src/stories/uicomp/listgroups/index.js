...
storiesOf("Listgroup", module)
  ...
  .add(
    ...
    withReadme(
      ListGroupReadme,
      withDocs(ListGroupDisabledDocs, () => (
        <Container style={{ textAlign: "left" }}>
          <ListGroup>
  ...
  .add(
    ...
    withReadme(
      ListGroupReadme,
      withDocs(ListGroupContextualDocs, () => (
        <Container style={{ textAlign: "left" }}>
          <ListGroup>
            <ListGroupItem>Cras justo odio</ListGroupItem>
            <ListGroupItem primary>
              This is a primary list group item
            </ListGroupItem>
            <ListGroupItem secondary>
              This is a secondary list group item
            </ListGroupItem>
            <ListGroupItem success>
              This is a success list group item
            </ListGroupItem>
            <ListGroupItem danger>
              This is a danger list group item
            </ListGroupItem>
            <ListGroupItem warning>
  ...
  .add(
    ...
    withReadme(
      ListGroupReadme,
      withDocs(ListGroupContextualLinksDocs, () => (
        <Container style={{ textAlign: "left" }}>
          <ListGroup>
            <ListGroupItem action>Cras justo odio</ListGroupItem>
            <ListGroupItem primary action>
              This is a primary list group item
            </ListGroupItem>
            <ListGroupItem secondary action>
              This is a secondary list group item
            </ListGroupItem>
            <ListGroupItem success action>
              This is a success list group item
            </ListGroupItem>
            <ListGroupItem danger action>
              This is a danger list group item
            </ListGroupItem>
            <ListGroupItem warning action>
              This is a warning list group item
            </ListGroupItem>
            <ListGroupItem info action>
              This is a info list group item
            </ListGroupItem>
            <ListGroupItem light action>
              This is a light list group item
            </ListGroupItem>
            <ListGroupItem dark action>
