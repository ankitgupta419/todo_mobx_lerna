...
storiesOf("Input groups", module)
  ...
  .add(
    ...
    withReadme(
      FormReadme,
      withDocs(InputGroupCheckboxRadioDocs, () => (
        <Container fluid style={{ textAlign: "left" }}>
          <InputGroup mb="0.5rem">
            <InputGroupPrepend>
              <InputGroupText>
  ...
  .add(
    ...
    withReadme(
      FormReadme,
      withDocs(InputGroupMultipleInputsDocs, () => (
        <Container fluid style={{ textAlign: "left" }}>
          <InputGroup mb="0.5rem">
            <InputGroupPrepend>
  ...
  .add(
    ...
    withReadme(
      FormReadme,
      withDocs(InputGroupMultipleAddonsDocs, () => (
        <Container fluid style={{ textAlign: "left" }}>
          <InputGroup mb="0.5rem">
            <InputGroupPrepend>
              <InputGroupText>$</InputGroupText>
  ...
  .add(
    ...
    withReadme(
      FormReadme,
      withDocs(InputGroupButtonAddonsDocs, () => (
        <Container fluid style={{ textAlign: "left" }}>
          <InputGroup mb="0.5rem">
            <InputGroupPrepend>
