...
import { Alert } from "uicomp/alert";
import { Container } from "uicomp/container";
import { base } from "uibase";
const { A, Hr, H4, P } = base;

import AlertReadme from "uicomp/alert/README.md";
...
storiesOf("Alerts", module)
    ...
    withReadme(
      ...
      withDocs(AlertLinkColorDocs, () => (
        <Container style={{ textAlign: "left" }}>
          ...
          <Alert secondary>
            This is a secondary alert with <A href="#">an example link</A>. Give
            it a click if you like.
          </Alert>
          <Alert success>
          ...
          <Alert danger>
            This is a danger alert with <A href="#">an example link</A>. Give it
            a click if you like.
          </Alert>
          <Alert warning>
          ...
          <Alert info>
            This is a info alert with <A href="#">an example link</A>. Give it a
            click if you like.
          </Alert>
          <Alert light>
            This is a light alert with <A href="#">an example link</A>. Give it
            a click if you like.
          </Alert>
          <Alert dark>
  ...
  .add(
    ...
    withReadme(
      AlertReadme,
      withDocs(AlertAdditionalContentDocs, () => (
        <Container style={{ textAlign: "left" }}>
          <Alert success>
            <H4>Well done!</H4>
            <P>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin
              malesuada ante metus, eu tempus erat ultricies imperdiet.
            </P>
            <Hr />
  ...
  .add(
    "Dismiss alert",
    withReadme(AlertReadme, withDocs(AlertDismissDocs, () => <DismissAlert />))
  );
