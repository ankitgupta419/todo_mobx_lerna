...
storiesOf("Badges", module)
  ...
  .add(
    ...
    withReadme(
      BadgeReadme,
      withDocs(BadgeContextualVariationDocs, () => (
        <Container style={{ textAlign: "left" }}>
          <Badge primary m="0.5rem">
            Primary
          </Badge>
          <Badge secondary m="0.5rem">
            Secondary
          </Badge>
          <Badge success m="0.5rem">
            Success
          </Badge>
          <Badge danger m="0.5rem">
            Danger
          </Badge>
          <Badge warning m="0.5rem">
            Warning
          </Badge>
          <Badge info m="0.5rem">
            Info
          </Badge>
          <Badge light m="0.5rem">
            Light
          </Badge>
          <Badge dark m="0.5rem">
            Dark
  ...
  .add(
    ...
    withReadme(
      BadgeReadme,
      withDocs(BadgePillBadgesDocs, () => (
        <Container style={{ textAlign: "left" }}>
          <Badge pill primary m="0.5rem">
            Primary
          </Badge>
          <Badge pill secondary m="0.5rem">
            Secondary
          </Badge>
          <Badge pill success m="0.5rem">
            Success
          </Badge>
          <Badge pill danger m="0.5rem">
            Danger
          </Badge>
          <Badge pill warning m="0.5rem">
            Warning
          </Badge>
          <Badge pill info m="0.5rem">
            Info
          </Badge>
          <Badge pill light m="0.5rem">
            Light
          </Badge>
          <Badge pill dark m="0.5rem">
            Dark
          </Badge>
        </Container>
      ))
