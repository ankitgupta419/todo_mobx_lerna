...
import { Column, Row } from "../../../packages/styled-grid-system-component";
...
storiesOf("Grid", module)
  .add(
    ...
    withReadme(
      GridReadme,
      withDocs(GridSimpleDocs, () => (
        <Container fluid>
          <Row>
            <p>
              The blue background color, the white color and the white border
              are just for demonstration purposes. Actually a container does not
              have a background color, a color or a border.
            </p>
          </Row>
          <Row>
            <Column
