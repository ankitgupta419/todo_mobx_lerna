...
storiesOf("Navs", module)
  ...
  .add(
    ...
    withReadme(
      NavReadme,
      withDocs(NavHorizontalCenterDocs, () => (
        <Container fluid>
          <Nav center>
            <NavLink active href="#">
              Active
  ...
  .add(
    ...
    withReadme(
      NavReadme,
      withDocs(NavPillsDocs, () => (
        <Container fluid>
          <Nav>
            <NavLink pills active href="#">
              Active
            </NavLink>
            <NavLink pills href="#">
              Link
  ...
  .add(
    ...
    withReadme(
      NavReadme,
      withDocs(NavJustifiedDocs, () => (
        <Container fluid>
          <Nav justified>
            <NavLink pills item active href="#">
              Active
            </NavLink>
            ...
            <NavLink pills item disabled href="#">
              Disabled
            </NavLink>
          </Nav>
        </Container>
