...
storiesOf("Table", module)
  ...
  .add(
    "Striped Bordered Dark",
    withReadme(
      TableReadme,
      withDocs(TableStripedBorderedDarkDocs, () => (
        <Container fluid>
  ...
  .add(
    "Responsive tables at breakpoints",
    withReadme(
      TableReadme,
      withDocs(TableResponsiveAtBreakpointsDocs, () => (
        <Container fluid>
          <Table responsiveSm>
            <TheadLong />
            <TbodyLong />
